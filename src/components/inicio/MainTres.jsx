...
export default function MainTres(){
    return(
        <div className="w-full mb-0 lg:mb-0 lg:h-[100%] flex flex-col-reverse lg:flex lg:flex-row  lg:items-center px-10 xl:pl-0 mt-10 lg:mt-10 relative">
            <div className="absolute w-[60vw] h-[80vh] bg-[#e6e6d4] top-[-80px]"></div>
            <div className="w-[100%]  z-10 lg:w-[90%] mb-10 lg:mb-0 lg:ml-0 ">
                ...
                <p className="text-2xl helvetica ml-20 text-center w-[80%] mt-9 px-20" style={{lineHeight: 1.4}}>Los ventiladores industriales BIOFAN,
            ...
            <div className="w-[110%] lg:w-[110%] bg-white px-20 hover:scale-105 transition z-10 ml-0">
               <Image loading="lazy" className="pt-5" src="/inicio/inicio_main_3.png" width={850} height={800} alt="imagen sobre nuestra experiencia" />
            </div>
        </div>
    )
}